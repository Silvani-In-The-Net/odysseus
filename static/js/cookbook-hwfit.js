    ...
    container.addEventListener('click', (e) => {
      ...
      if (wasActive) {
        ...
        if (quantSel) {
          ...
          } else if (String(system?.backend || '').toLowerCase() === 'rocm' || String(system?.backend || '').toLowerCase() === 'vulkan') {
            quantSel.value = 'Q4_K_M'; // ROCm/Vulkan default stays GGUF/local-safe; AWQ is explicit only
          } else {
